...
@section('title','Welcome to WiseFinAI! ')
@push('style-css')
@endpush
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="container-xxl " id="kt_content_container">
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="row g-8 mb-xl-10">
                        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                        ...
                                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                                    <div class="d-flex flex-column">
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <a href="javascript:;" class="text-gray-900 text-hover-success fs-2 fw-bold me-1">{{ isset($agent->fullname) ? $agent->fullname : 'WiseFinAI Support' }}</a>
                            ...
                            @else
                                <div class="card" data-bs-theme="light" style="background: linear-gradient(112.14deg, #8168a0 0%, #3e3a32 100%);">
                                    <div class="card-body">
                                        <div class="row align-items-center h-100">
                                            <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <h6 class="text-danger"><marquee scrollamount="8" behavior="scroll">BE AWARE! We ask our customers to make payments ONLY on our website https://wisefinai.com and NOT through any other source, directly or indirectly. Thanks!</marquee></h6>
                </div>
            </div>
        </div>
    </div>
