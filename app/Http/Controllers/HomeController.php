...
class HomeController extends Controller
{
    ...
    public function testdata(){
       ...
       $mailData = array(
        ...
        /* send email in brevo */
        $res = sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for WiseFinAI’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
