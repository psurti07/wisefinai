...
-----END PUBLIC KEY-----';       //header key
    ...
    public function StatusEnquiry(Request $request)
    {
        ...
        $actualReturnUrl = $secondLastSegment === 'self-apply' ? 'https://wisefinai.com/self-apply/premium-offer-response' : 'https://wisefinai.com/loan-agent/ultra-saver-offer-response';

        $redirectUrl = $paymentMessage === 'Transaction Successfull' ? $actualReturnUrl : 'https://wisefinai.com/cipher-payment-failed/';
