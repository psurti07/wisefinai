...
-----END PUBLIC KEY-----';       //header key
    ...
    public function buyNow()
    {
        ...
        $pdfUrl = 'https://wisefinai.com/application-pdf/'.$encUserId;
        ...
        try {
            ...
            if ($checksum == $recd_checksum) {
                ...
                if ($responseCode == 100 || $responseCode == 208 || /* $responseCode == 102 || */ $responseCode == 601) {
                    ...
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for WiseFinAI Self-Apply Plan.', $sendGreetings, 3, $pdf);
                    if ($response2 > 0) {
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if(Cookie::has('utm_source') && Cookie::get('utm_source') == 'facebook'){
                    ...
                    $fbdata = array(
    						...
    						'sourceurl' => 'https://wisefinai.com/self-apply/paymentSuccess'
    					);
    				if ($fbleads->fbclid != "") {
    ...
    public function getOffer3(Request $request)
    {
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://wisefinai.com/api/self-apply/premium-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try{
            ...
            $returnUrl = 'https://wisefinai.com/airpay-response';
    ...
    public function getOffer7(Request $request){
        try{
            ...
            $redirect_url = 'https://wisefinai.com/api/self-apply/offer-7-response';         // Required - http://, https://, http://www, https://www
