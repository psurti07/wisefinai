...
<section id="hero-7" class="bg--fixed hero-section">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-1 order-lg-1 m-auto">
                    <div class="img-block">
                        <img src="{{ asset('front/images/offer/loan-agent-silver-offer.jpg') }}" alt="selfapply nbfc list" class="img-fluid rounded-3">
                    </div>
             </div>

            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-2 order-lg-2 mb-lg-0 mb-25">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a> and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of WiseFinAI.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title text-center mb-40">
                    <h2 class="s-34 w-700 mb-5">Our <span class="color--green-500">Happy Customer</span></h2>
