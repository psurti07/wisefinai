    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-1 order-lg-1 m-auto">
                    <div class="img-block">
                        <img src="{{ asset('front/images/offer/loan-agent-great-deal-offer.jpg') }}" alt="selfapply nbfc list" class="img-fluid rounded-3">
                    </div>
            </div>
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-2 order-lg-2  mb-lg-0 mb-25 mb-lg-0 mb-25">
