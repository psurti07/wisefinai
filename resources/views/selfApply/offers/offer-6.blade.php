    ...
    <div class="container">
     ...
     <div class="col-md-6 col-lg-6 order-1 order-md-2 order-lg-2 mb-lg-0 mb-25">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 tetxt-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a> and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of WiseFinAI.</p>
                </div>
            </div>
        </div>
    </div>
