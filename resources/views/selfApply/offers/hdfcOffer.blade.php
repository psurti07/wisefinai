                ...
                <div class="row d-flex align-items-bottom">
                    <div class="col-md-5 order-2 order-md-1">
                        <div class="hero-7-img home-img d-flex justify-content-center align-items-start">
                            <img src="{{ asset('front/images/offer/offer-img.webp') }}" alt="WiseFinAI" class="img-fluid rounded-3">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 self-apply-form  form-container order-1 order-md-2">
                        <div id="hero-8-form" class="r-06 bg-white p-4">
                            ...
                            <p class="p-sm mt-3 mb-0">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a>  and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of WiseFinAI.</p>
                        </div>
                    </div>
                </div>
            </div>
