<footer id="footer-3" class="footer pt-0">
    <div class="container">
        <!-- FOOTER CONTENT -->
        <div class="row pt-80">
            <!-- FOOTER LOGO -->
            <div class="col-xl-4 mb-sm-20 mb-md-20">
                <div class="footer-info">
                    ...
                    <ul class="footer-socials mt-4 ico-25 text-center clearfix">
                        ...
                        <li>
                            <a href="{{ config('constant.SM_REDDIT'); }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-reddit" viewBox="0 0 16 16"  style="fill:#ffffff;height:1.325rem; position: relative;">
