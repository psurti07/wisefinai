<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18407712570"></script>
    <script>
        ...
        gtag('config', 'AW-18407712570');
    </script>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-K3FX30S7J9"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-WLJVJH62');
    </script>
